...
| Command      | Description                                                        |
| ------------ | ------------------------------------------------------------------ |
| _(default)_  | Start `flutter run` with JSON line streaming                       |
...
| ------------------------ | ----------------------------- | --------------------------------------------------------- |
| `getInteractiveElements` | _(none)_                      | `{elements: [{type, key, text, bounds, visible}], count}` |
